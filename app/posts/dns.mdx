...
a name and there's so many that is can be hard to remember where they all are.
When you want to play with a toy, instead of remembering where each toy is in
the room, you ask you friend. He's very organize and remembers everything, he
...
which is like the toys name. Instead of trying to remember all those numbers, we
use the Domain Name System or DNS, which is like your friend, to help us find
